...
module.exports = function (config) {
  ...
  config.set({
    ...
    files: [
      ...
      './vitrage_dashboard/dashboard/static/vendor/d3/**/d3.js',
      './vitrage_dashboard/dashboard/static/vendor/dagre-d3/**/dagre-d3.core.js',
      //'./vitrage_dashboard/dashboard/static/**/*.module.js',
      //'./vitrage_dashboard/dashboard/static/**/*.module.js',
       ...
       * significant.
       */
      './vitrage_dashboard/dashboard/static/**/!(*.spec|*.mock).js',
       ...
       * among them should not be significant.
       */
      './vitrage_dashboard/dashboard/static/app/core/openstack-service-api/vitrage.service.spec.js',

      /**
       * Angular external templates
       */
      './vitrage_dashboard/dashboard/static/**/*.html',
